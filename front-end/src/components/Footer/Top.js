  ...
  return (
    <Flex bg="black">
      ...
      <Box maxW="1200px" mx="auto" color="white">
        ...
        <List spacing={3}>
          <ListItem>
            <Link href="https://www.bigbasket.com/faq/" isExternal color="white" textDecoration="none" _hover={{textDecoration:"underline"}}>
              FAQs
            </Link>
          </ListItem>
          <ListItem>
            <Link href="https://www.bigbasket.com/contact/" isExternal color="white" textDecoration="none" _hover={{textDecoration:"underline"}}>
             Contact Us
            </Link>
          </ListItem>
          <ListItem>
            <Link href="https://www.bigbasket.com/bb-Wallet-faq/" isExternal color="white" textDecoration="none" _hover={{textDecoration:"underline"}}>
            bb-Wallet-faq            </Link>
          </ListItem>
          <ListItem>
            <Link href="https://www.bigbasket.com/bb-wallet-terms-and-conditions/" isExternal color="white" textDecoration="none" _hover={{textDecoration:"underline"}}>
              BB wallet T&Cs
            </Link>
          </ListItem>
          <ListItem>
            <Link href="https://nucleus.bigbasket.com/" isExternal color="white" textDecoration="none" _hover={{textDecoration:"underline"}}>
              Vendor Connect
            </Link>
          </ListItem>     
        </List>
